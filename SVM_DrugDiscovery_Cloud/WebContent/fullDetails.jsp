...
<!-- //Custom Theme files -->
<link
	href="${pageContext.request.contextPath}/resources/css/minimal-slider.css"
	...
	<header>
				...
				<ul class="navbar-nav ml-lg-auto text-center">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							<a href="findUser/${msg}">User Details</a> <a
		...
		<div class="sidebar">
			<br> <br> <br> <br> <a href="index.jsp"><i
				...
				Drug</a> <a href="testerInfo/${msg}">Testers Info</a>
			...
			<div class="container">
				<div class="about-main">
					<div class="about-right">
						<h3 class="subheading-w3-agile">Drug Details
							</h3>
						<!-- stats -->
						<div class="stats">
							...
							<div class="stats_inner">
								<form action="FullDrugDetails" method="post">

									<input class="form-control date mb-3" id="name" name="drugname"
										type="text" required="required" value="${drugname}" readonly="readonly">
									<input class="form-control date mb-3" id="name" name="ingredients"
										type="text" required="required" placeholder="Ingredients">

									<input class="form-control date mb-3" 
										name="strength" placeholder="Strength" type="text"
										required="required">
										
										<input class="form-control date mb-3" id="name" name="dosageform"
										type="text" required="required" placeholder="Dosage Form">

									<button type="submit" class="btn btn-agile btn-block w-100">Upload Details</button>
								</form>
							</div>
						</div>
						<!-- //stats -->
		...
		function readSingleFile(evt) {
			...
			if (f) {
				...
				r.onload = function(e) {
					...
					alert("Got the file " + "name: " + f.name + "n" + "type: "
