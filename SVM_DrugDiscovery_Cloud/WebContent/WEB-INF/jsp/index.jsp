...
<meta name="keywords" content="Alleviating Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
    ...
    <!-- //Custom Theme files -->
	<link href="resources/css/minimal-slider.css" rel='stylesheet' type='text/css' />
						...
						<ul class="slides">
								...
								<div class="w3_testimonials_grid">
									...
									<div class="row person-w3ls-testi mt-5">
										<div class="col-6 agile-left-test text-right">
											<img src="resources/images/te1.jpg" alt=" " class="img-fluid rounded-circle" />
										</div>
							...
							<li>
								<div class="w3_testimonials_grid">
									...
									<div class="row person-w3ls-testi mt-5">
										<div class="col-6 agile-left-test text-right">
											<img src="resources/images/te2.jpg" alt=" " class="img-fluid rounded-circle" />
										</div>
										<div class="col-6 agile-right-test text-left mt-4">
											<h5>John Lara</h5>
											<p>Tempore Quo</p>
							...
							<li>
								<div class="w3_testimonials_grid">
									...
									<div class="row person-w3ls-testi mt-5">
										<div class="col-6 agile-left-test text-right">
											<img src="resources/images/te3.jpg" alt=" " class="img-fluid rounded-circle" />
										</div>
										<div class="col-6 agile-right-test text-left mt-4">
											<h5>Frank John </h5>
											<p>Tempore Quo</p>
                    ...
                    <div class="login px-4 mx-auto mw-100">
                        ...
                        <form action="ownerRegister" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="username" id="validationDefault01" placeholder="" required="">
                            </div>
                            

                            <div class="form-group">
                                <label class="mb-2 col-form-label">Password</label>
                                <input type="password" class="form-control" id="password1" placeholder="" required="" name="password">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label">Contact No</label>
                                <input type="text" class="form-control" name="phone" id="password2" placeholder="" required="">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label">Lab Name</label>

                                <input type="text" class="form-control" name="labname" id="validationDefault01" placeholder="" required="">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label">Lab Code</label>

                                <input type="text" class="form-control" name="labcode" id="validationDefault01" placeholder="" required="">
                            </div>
