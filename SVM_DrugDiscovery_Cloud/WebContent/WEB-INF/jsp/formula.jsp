							...
							<div class="stats_inner">
								<form action="drugUpload" method="post" enctype="multipart/form-data">
									...
									<input class="form-control date mb-3" id="datepicker"
									 ...
									 <input  class="form-control date mb-3" type="file" name="file" /> 
