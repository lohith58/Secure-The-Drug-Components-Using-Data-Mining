...
<link href="WebContent/resources/css/bootstrap.css" type="text/css"
	rel="stylesheet" media="all">
<link href="WebContent/resources/css/style.css" type="text/css" rel="stylesheet"
	media="all">
<!-- font-awesome icons -->
<link href="WebContent/resources/css/fontawesome-all.min.css" rel="stylesheet">
<!-- //Custom Theme files -->
<link href="WebContent/resources/css/minimal-slider.css" rel='stylesheet'
	type='text/css' />
<link rel="stylesheet" href="WebContent/resources/css/flexslider.css"
	...
	<header>
				...
				<ul class="navbar-nav ml-lg-auto text-center">
					...
					<li class="nav-item dropdown mr-3 mt-lg-0 mt-3"><img
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="about.html">User Details</a>
		...
		<br>
			<a href="index.jsp"><i class="fa fa-fw fa-home"></i> Home</a>
			 <a
href="findFile/${msg}">Uploaded Drug</a> 
				<a href="testerslist.jsp">Testers Info</a> 
				<a href="testerslist.jsp">Testers List</a> 
...
<br>
	...
	<!-- //footer -->
	<!-- js -->
	<script src="WebContent/resources/js/jquery-2.2.3.min.js"></script>
	<!-- //js -->
	<script src="WebContent/resources/js/minimal-slider.js"></script>
	<!-- flexSlider (for testimonials) -->
	<!-- Calendar -->
	<link rel="stylesheet" href="WebContent/resources/css/jquery-ui.css" />
	<script src="WebContent/resources/js/jquery-ui.js"></script>
	<script>
		$(function() {
	...
	<script defer src="WebContent/resources/js/jquery.flexslider.js"></script>
	<script>
	...
	<script src="WebContent/resources/js/move-top.js"></script>
	<script src="WebContent/resources/js/easing.js"></script>
	<script>
	...
	<script src="WebContent/resources/js/SmoothScroll.min.js"></script>
	<!-- //smooth-scrolling-of-move-up -->
