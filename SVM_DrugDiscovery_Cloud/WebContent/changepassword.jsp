						...
						<div class="stats">
							...
							<div class="stats_inner">
								<form action="changePassword" method="post">
									...
									<input class="form-control date mb-3" id="name"
										name="opassword" type="password" required="required"
										placeholder="Old Password"> <input
										class="form-control date mb-3" id="name" name="npassword"
										type="password" required="required" placeholder="New Password">

									<button type="submit" class="btn btn-agile btn-block w-100">Change
										Password</button>
								</form>
							</div>
						</div>
