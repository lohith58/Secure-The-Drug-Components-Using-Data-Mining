						...
						<div class="col-xl-7 col-lg-6 col-md-4 top-social-agile text-md-right text-center mt-md-0 mt-2">
							<div class="row">
								...
								<div class="col-xl-3 col-lg-4 col-6 top-w3layouts p-md-0 text-right">
									<!-- login -->
									<a href="login.jsp" class="login-button-2 text-uppercase text-bl">
										<span class="fa fa-sign-in mr-2"></span>Login</a>
									<!-- //login -->
								</div>
								<div class="col-xl-3 col-lg-4 col-6 header-w3layouts text-md-right text-left">
									<!-- register -->
									<a href="register.jsp" class="login-button-2 text-uppercase text-bl">
					...
					<li class="banner-top1">
						<div class="container">
							<div class="banner-info_agile_w3ls text-center mx-auto">
								<h3 class="text-wh font-weight-bold">Providing extensive family Health care</h3>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<img class="card-img-bottom" src="resources/images/blog1.jpg" alt="image">
						</div>
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<img class="card-img-bottom" src="resources/images/blog3.jpg" alt="image">
						</div>
						<div class="card-body border border-top-0">
							<div class="mb-3">
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<img class="card-img-bottom" src="resources/images/blog2.jpg" alt="image">
						</div>
						<div class="card-body border border-top-0">
							<div class="mb-3">
		...
		<div class="container pb-xl-5 pb-lg-3">
			<div class="row mt-30">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="box16">
						<img src="resources/images/team1.jpg" alt="" class="img-fluid">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="box16">
						<img src="resources/images/team2.jpg" alt="" class="img-fluid">
						<div class="box-content">
			...
			<div class="row mt-sm-5">
				<div class="offset-lg-4 col-lg-4 col-sm-6">
					<div class="box16">
						<img src="resources/images/team3.jpg" alt="" class="img-fluid">
						<div class="box-content">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="box16">
						<img src="resources/images/team4.jpg" alt="" class="img-fluid">
						<div class="box-content">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="single.html">
								<img class="card-img-bottom" src="resources/images/g1.jpg" alt="image">
							</a>
						</div>
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						...
						<div class="card-header p-0">
							<a href="single.html">
								<img class="card-img-bottom" src="resources/images/g3.jpg" alt="image">
							</a>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="single.html">
								<img class="card-img-bottom" src="resources/images/g2.jpg" alt="image">
							</a>
						</div>
						<div class="card-body border border-top-0 pb-5">
							<div class="mb-3">
			...
			<div class="row mt-5">
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="single.html">
								<img class="card-img-bottom" src="resources/images/g4.jpg" alt="image">
							</a>
						</div>
						<div class="card-body border border-top-0 pb-5">
							<div class="mb-3">
